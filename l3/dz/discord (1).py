...
async def on_message(message):
    ...
    if message.content.startwith('!start'):
    ...
    elif (message.content.startswith('!1')) and a == ('!1') or (message.content.startswith('!2')) and a == ('!2') or (message.content.startswith('!3')) and a == ('!3'):
        msg = 'Нічия'
        await message.channel.send(msg)
        ...
        msg=('Ви обрали камінь'/n + 'Бот обрав ножиці'/n + 'Ви перемогли')
        await message.channel.send(msg)
    elif (message.content.startswith('!3')) and a == ('!2'):
